...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("2 " + "You have " + truck.getTipAuto() + " de model " + truck.getModel() + " care are " + truck.getSeats() + " locuri "+"si culoarea "+truck.getColor());
        System.out.println("3" + " You choose the " + bus.getTipAuto() + ":\n - with capacity " + bus.getSeats() + " seats:" + "\n - and max. speed limit: " + "\u001B[31m" + bus.getMaxSpeed() + "\u001B[0m km/h: \n - licence plate: \u001B[32m" + bus.getLicensePlate() + "\u001B[0m\n"+" - weight: "+bus.getWeight()+" kg");
        System.out.println("4 You can drive your " + moto.getTipAuto() + " at max speed:\u001B[31m " + moto.getMaxSpeed() + "\u001B[0m km/h");
        System.out.println("5 AUTO with license plate " + auto.getLicensePlate());
    }
